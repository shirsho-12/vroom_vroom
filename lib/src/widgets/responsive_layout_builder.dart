  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= VroomVroomBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= VroomVroomBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= VroomVroomBreakpoints.large) {
